    ...
    <>
      <table style={{marginLeft:"0px",marginTop:"100px"}}>
        <thead>
          ...
          <th style={{paddingLeft:"30px"}}>Arrival </th>
        ...
        <tbody>
          {apidata.map((e) => { return <tr >
              ...
              <td style={{padding:"30px"}}>{e.name}</td>
              <td style={{padding:"30px"}}>{e.email}</td>
              <td style={{padding:"30px"}}>{e.phone}</td>
              <td style={{padding:"30px"}}>{e.room}</td>
              <td style={{padding:"30px",paddingLeft:"40px"}}>{e.arrival}</td>
              <td style={{padding:"30px",paddingLeft:"40px"}}>{e.departure}</td>
              <td style={{padding:"30px",paddingLeft:"60px"}}>{e.adult}</td>
      ...
      <div id="from">
        <form action="" onSubmit={submitfrom}>
          ...
          <select name="room" value={frminp.room} onChange={changeinput}>
